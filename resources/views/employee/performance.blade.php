    ...
    <div class="flex items-center gap-6">
        @if($data['latest'])
            ...
            <div>
                ...
                <p class="text-sm font-medium text-slate-500">Reviewed by: {{ $data['latest']->reviewer_name }}</p>
            </div>
        @else
            ...
            <div>
                ...
                <p class="text-xs font-medium text-slate-400">Your evaluations will appear here once submitted.</p>
            </div>
        @endif
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        ...
        <div class="space-y-5">
            ...
            @empty
                <p class="text-xs text-slate-400 text-center py-6">No competencies recorded for this period.</p>
            @endforelse
        </div>
    </div>
